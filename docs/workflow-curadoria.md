...
2. **docs/README.md** — analisa o projeto, apresenta
   resumo ao humano:
...
<changeDescription>
Corrigir título, referências /doc/ no objetivo e adicionar seção de posicionamento na sequência de workflows
</changeDescription>
