...
- skills/performance-optimization/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with profiling and web-specific
  terms (N+1 query, memory leak, render blocking, lighthouse score)
