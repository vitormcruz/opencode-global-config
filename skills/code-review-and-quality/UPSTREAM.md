...
- skills/code-review-and-quality/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with five-axis review terms
  (LGTM, agent output review, smell, technical debt) to improve activation.
