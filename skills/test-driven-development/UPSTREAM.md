...
- skills/test-driven-development/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with patterns from the skill body
  (Prove-It Pattern, browser testing, flaky tests, mocking, regression)
