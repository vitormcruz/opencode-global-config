...
- skills/git-workflow-and-versioning/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section (which simply states "Always") and enriched
  with practical git operation terms (stash, squash, stage, rollback,
  commit message, git log) to improve activation.
