...
- skills/frontend-ui-engineering/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_lang: en
description_note: >
  Kept in English (source language). Triggers extracted from body
  "When to Use" section and enriched with concrete framework and
  pattern terms (Tailwind, styled components, design tokens, form,
  modal, navigation, TypeScript component) to improve activation.
