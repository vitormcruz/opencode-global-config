...
- skills/code-simplification/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with cognitive-load and smell terms
  (cyclomatic complexity, dead code, rename, consolidate) to improve activation.
