...
- skills/api-and-interface-design/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with design principles from the
  skill body (Hyrum's Law, OpenAPI, pagination design, error responses,
  backward compatibility) to improve activation.
