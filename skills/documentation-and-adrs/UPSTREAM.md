...
- skills/documentation-and-adrs/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with terms from the skill body
  (decision log, runbook, system design doc, context for future engineers)
