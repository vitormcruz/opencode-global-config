...
- skills/spec-driven-development/SKILL.md  (corpo — copiado apenas na criacao inicial)
...
description_note: >
  ...
  "When to Use" section and enriched with gated workflow terms and
  the "30 minutes" heuristic from the skill body to improve activation.
